    ...
    <div className="lottery-wrapper">
      ...
      <div className={`lottery-game-area ${!canPlay ? 'disabled' : ''}`}>
        <div className="lottery-particles">
          ...
          <span className="particle" style={{ left: '25%', animationDelay: '1.2s' }}>
            ✨
          </span>
          <span className="particle" style={{ left: '45%', animationDelay: '0.6s' }}>
            🎀
          </span>
          <span className="particle" style={{ left: '65%', animationDelay: '1.8s' }}>
            ⭐
          </span>
          <span className="particle" style={{ left: '80%', animationDelay: '0.3s' }}>
            ✨
          </span>
          <span className="particle" style={{ left: '90%', animationDelay: '2.1s' }}>
            🎁
          </span>
        </div>
        <GiftBox ref={ref} boxes={boxes} onEnd={handleEnd} />
        {canPlay && <div className="lottery-hint">点击任意宝箱试试运气吧 🎁</div>}
      </div>
      ...
      {lastResult && (
        <div className="card lottery-result-card">
          ...
          <div className="lottery-result-amount">+{lastResult.amount} 元代金券</div>
