...
export default function HeroAvatar({ size = 52, className, animClass }: HeroAvatarProps) {
  return (
    <div className={`${className || ''} ${animClass || ''}`} style={{ width: size, height: size, flexShrink: 0 }}>
      <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
        ...
        <g filter="url(#hero-glow)">
          {/* ===== 剑（右手举起）===== */}
          <line x1="72" y1="48" x2="82" y2="18" stroke="url(#sword-blade)" strokeWidth="3.5" strokeLinecap="round" />
          <line x1="72" y1="48" x2="82" y2="18" stroke="#4ADE80" strokeWidth="1" opacity="0.4" />
          {/* 剑柄护手 */}
          <line x1="67" y1="46" x2="77" y2="50" stroke="#D97706" strokeWidth="3" strokeLinecap="round" />
          {/* 剑柄 */}
          <line x1="64" y1="48" x2="69" y2="50" stroke="#92400E" strokeWidth="2.5" strokeLinecap="round" />
          {/* 剑尖光芒 */}
          <circle cx="82" cy="18" r="3" fill="#4ADE80" opacity="0.6" />

          {/* ===== 盾牌（左手）===== */}
          <path d="M22 40 L18 56 L28 62 L38 56 L34 40 Z" fill="url(#shield-surface)" stroke="#60A5FA" strokeWidth="1" />
          {/* 盾牌星星 */}
          <path d="M28 44 L29.5 48 L34 48 L30.5 51 L32 55 L28 52.5 L24 55 L25.5 51 L22 48 L26.5 48 Z" fill="#FBBF24" opacity="0.9" />

          {/* ===== 身体/铠甲 ===== */}
          <path d="M36 42 L34 76 L66 76 L64 42 Z" fill="#3B82F6" stroke="#60A5FA" strokeWidth="0.8" />
          {/* 铠甲中线 */}
          ...
          {/* 铠甲肩甲 */}
          <path d="M34 42 L28 44 L30 50 L36 48 Z" fill="#2563EB" stroke="#60A5FA" strokeWidth="0.5" />
          <path d="M66 42 L72 44 L70 50 L64 48 Z" fill="#2563EB" stroke="#60A5FA" strokeWidth="0.5" />

          {/* ===== 头部 ===== */}
          {/* 头盔 */}
          <path d="M36 34 C36 18 42 12 50 12 C58 12 64 18 64 34 L64 40 L36 40 Z" fill="#6366F1" stroke="#818CF8" strokeWidth="0.8" />
          {/* 头盔帽檐 */}
          ...
          {/* ===== 披风 ===== */}
          <path d="M34 42 C28 52 26 66 28 84 L34 84 C32 68 34 54 36 46 Z" fill="#7C3AED" opacity="0.5" />
