...
// 骷髅兵
const Skeleton = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#skull-glow)">
      <path d="M50 18 C34 18 22 30 22 44 C22 52 26 58 32 62 L32 72 C32 76 36 80 40 80 L60 80 C64 80 68 76 68 72 L68 62 C74 58 78 52 78 44 C78 30 66 18 50 18Z" fill="#E8DCC8" stroke="#8B7D6B" strokeWidth="1.5" />
      {/* 左眼窝 */}
      ...
      {/* 牙齿 */}
      <rect x="36" y="68" width="4" height="7" rx="1" fill="#E8DCC8" stroke="#8B7D6B" strokeWidth="0.5" />
      <rect x="42" y="68" width="4" height="8" rx="1" fill="#E8DCC8" stroke="#8B7D6B" strokeWidth="0.5" />
      <rect x="48" y="68" width="4" height="7" rx="1" fill="#E8DCC8" stroke="#8B7D6B" strokeWidth="0.5" />
      <rect x="54" y="68" width="4" height="8" rx="1" fill="#E8DCC8" stroke="#8B7D6B" strokeWidth="0.5" />
      <rect x="60" y="68" width="4" height="7" rx="1" fill="#E8DCC8" stroke="#8B7D6B" strokeWidth="0.5" />
      {/* 下颚裂缝 */}
...
const Bat = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#bat-glow)">
      {/* 左翼 */}
      <path d="M46 44 C36 30 20 22 10 30 C14 36 18 42 24 46 C20 44 12 44 8 50 C16 50 24 50 30 52 C26 54 18 58 14 66 C22 60 30 54 38 54 L46 54 Z" fill="#2D1B4E" stroke={glowColor} strokeWidth="0.8" />
      {/* 右翼 */}
      <path d="M54 44 C64 30 80 22 90 30 C86 36 82 42 76 46 C80 44 88 44 92 50 C84 50 76 50 70 52 C74 54 82 58 86 66 C78 60 70 54 62 54 L54 54 Z" fill="#2D1B4E" stroke={glowColor} strokeWidth="0.8" />
      {/* 身体 */}
      <ellipse cx="50" cy="50" rx="10" ry="14" fill="#3B1D6E" stroke={glowColor} strokeWidth="0.5" />
      {/* 眼睛 */}
...
const Treant = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#treant-glow)">
      {/* 树干身体 */}
      <path d="M38 30 L36 82 L44 82 L46 50 L54 50 L56 82 L64 82 L62 30 Z" fill="#3D2817" stroke="#5C3D1E" strokeWidth="1" />
      {/* 树冠/头部 */}
      <ellipse cx="50" cy="28" rx="22" ry="18" fill="#2D4A1A" stroke={glowColor} strokeWidth="0.8" />
      ...
      {/* 手臂/树枝 */}
      <path d="M36 42 L18 36 L14 30" stroke="#3D2817" strokeWidth="4" strokeLinecap="round" fill="none" />
      <path d="M64 42 L82 36 L86 30" stroke="#3D2817" strokeWidth="4" strokeLinecap="round" fill="none" />
      {/* 腐化纹路 */}
...
const Knight = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#knight-glow)">
      {/* 头盔 */}
      <path d="M32 36 C32 20 40 12 50 12 C60 12 68 20 68 36 L68 46 L32 46 Z" fill="#4A5568" stroke="#718096" strokeWidth="1" />
      {/* 面罩 */}
      ...
      {/* 斗篷 */}
      <path d="M28 46 C20 56 18 72 22 88 L28 88 C24 74 26 60 32 52 Z" fill="#1F2937" opacity="0.8" />
    </g>
  </svg>
);
...
const Golem = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#golem-glow)">
      ...
      {/* 头部 */}
      <rect x="36" y="18" width="28" height="24" rx="4" fill="#6B3A12" stroke="#8B4A1A" strokeWidth="1" />
      {/* 岩石纹理 */}
      ...
      {/* 嘴 - 熔岩裂缝 */}
      <path d="M42 36 L44 38 L48 35 L52 38 L54 36 L56 38" stroke={glowColor} strokeWidth="1.5" fill="none" />
      {/* 手臂 */}
      <path d="M30 44 L16 52 L14 60" stroke="#6B3A12" strokeWidth="8" strokeLinecap="round" fill="none" />
      <path d="M70 44 L84 52 L86 60" stroke="#6B3A12" strokeWidth="8" strokeLinecap="round" fill="none" />
      {/* 熔岩裂纹 */}
...
const Spirit = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#spirit-glow)" opacity="0.9">
      {/* 灵体身体 - 透明飘渺 */}
      <path d="M34 42 C34 28 42 18 50 18 C58 18 66 28 66 42 C66 56 62 68 58 78 C56 84 54 90 52 94 C50 90 48 84 46 78 C42 68 38 56 34 42Z" fill={color} fillOpacity="0.6" stroke={glowColor} strokeWidth="0.8" />
      {/* 内部波动 */}
      <path d="M40 50 C44 46 48 54 52 48 C56 44 60 52 64 48" stroke={glowColor} strokeWidth="0.5" opacity="0.4" fill="none" />
      <path d="M38 60 C42 56 48 64 52 58 C56 54 60 62 66 58" stroke={glowColor} strokeWidth="0.5" opacity="0.3" fill="none" />
      {/* 眼睛 */}
...
const Dragon = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#dragon-glow)">
      {/* 龙头 */}
      <path d="M30 30 C30 18 40 10 50 10 C60 10 70 18 70 30 L70 50 C70 56 62 62 50 62 C38 62 30 56 30 50 Z" fill={color} stroke={glowColor} strokeWidth="1" />
      {/* 角 */}
      ...
      {/* 火焰呼吸 */}
      <path d="M42 56 L46 68 L50 62 L54 68 L58 56" fill={glowColor} fillOpacity="0.6" stroke={glowColor} strokeWidth="0.5" />
      {/* 翼展 */}
      <path d="M30 36 L8 28 L12 40 L6 46 L16 46 L12 54 L24 48 L30 44 Z" fill="#7F1D1D" stroke={glowColor} strokeWidth="0.5" opacity="0.7" />
      <path d="M70 36 L92 28 L88 40 L94 46 L84 46 L88 54 L76 48 L70 44 Z" fill="#7F1D1D" stroke={glowColor} strokeWidth="0.5" opacity="0.7" />
      {/* 鳞片纹路 */}
...
// 冰封领主
const FrostLord = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#frost-glow)">
      {/* 王冠 */}
      <path d="M30 28 L34 14 L40 24 L46 10 L50 22 L54 10 L60 24 L66 14 L70 28 Z" fill={glowColor} stroke="#fff" strokeWidth="0.5" />
      {/* 面部 */}
      <path d="M32 30 C32 20 40 14 50 14 C60 14 68 20 68 30 L68 50 C68 58 60 64 50 64 C40 64 32 58 32 50 Z" fill="#1E3A5F" stroke={glowColor} strokeWidth="1" />
      {/* 眼睛 */}
      ...
      {/* 冰霜胡须 */}
      <path d="M42 48 C44 56 46 64 48 72 L50 76 L52 72 C54 64 56 56 58 48" stroke={glowColor} strokeWidth="1.5" fill="none" opacity="0.6" />
      {/* 冰晶身体 */}
      <path d="M32 54 L28 86 L72 86 L68 54" fill="#1E3A5F" stroke={glowColor} strokeWidth="0.8" />
      {/* 冰霜装饰 */}
      <path d="M38 60 L42 58 L46 62" stroke={glowColor} strokeWidth="0.5" opacity="0.5" fill="none" />
      <path d="M54 62 L58 58 L62 60" stroke={glowColor} strokeWidth="0.5" opacity="0.5" fill="none" />
      {/* 冰杖 */}
...
// 雷霆兽王
const ThunderBeast = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#thunder-glow)">
      {/* 兽头 */}
      <path d="M26 36 C26 18 38 8 50 8 C62 8 74 18 74 36 L74 56 C74 66 64 74 50 74 C36 74 26 66 26 56 Z" fill={color} stroke={glowColor} strokeWidth="1" />
      {/* 兽角 */}
      ...
      {/* 闪电纹路 */}
      <path d="M44 20 L48 26 L44 28 L50 36" stroke={glowColor} strokeWidth="1.2" fill="none" opacity="0.7" />
      <path d="M56 20 L52 26 L56 28 L50 36" stroke={glowColor} strokeWidth="1.2" fill="none" opacity="0.7" />
      {/* 眼睛 */}
      ...
      {/* 雷电纹身 */}
      <path d="M42 60 L46 68 L42 70 L48 80" stroke={glowColor} strokeWidth="1" fill="none" opacity="0.6" />
      <path d="M58 60 L54 68 L58 70 L52 80" stroke={glowColor} strokeWidth="1" fill="none" opacity="0.6" />
      {/* 闪电特效 */}
      <path d="M10 16 L14 28 L10 28 L16 42" stroke={glowColor} strokeWidth="2" fill="none" opacity="0.5" />
      <path d="M90 16 L86 28 L90 28 L84 42" stroke={glowColor} strokeWidth="2" fill="none" opacity="0.5" />
    </g>
  </svg>
);

// 黑暗魔王
const DemonLord = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#demon-glow)">
      {/* 巨角 */}
      <path d="M28 28 C22 20 16 6 10 2 C12 12 14 22 22 30 Z" fill="#1C1917" stroke={glowColor} strokeWidth="1" />
      <path d="M72 28 C78 20 84 6 90 2 C88 12 86 22 78 30 Z" fill="#1C1917" stroke={glowColor} strokeWidth="1" />
      {/* 面部 */}
      <path d="M28 30 C28 16 38 8 50 8 C62 8 72 16 72 30 L72 56 C72 64 62 72 50 72 C38 72 28 64 28 56 Z" fill={color} stroke={glowColor} strokeWidth="1.2" />
      {/* 第三只眼 */}
      ...
      {/* 邪恶笑容 */}
      <path d="M36 54 C40 60 44 62 50 62 C56 62 60 60 64 54" stroke={glowColor} strokeWidth="1.5" fill="none" />
      {/* 獠牙 */}
      ...
      {/* 暗黑翅膀 */}
      <path d="M28 44 C16 40 6 46 4 56 C10 52 16 50 22 52 L28 48 Z" fill="#1C1917" stroke={glowColor} strokeWidth="0.5" opacity="0.6" />
      <path d="M72 44 C84 40 94 46 96 56 C90 52 84 50 78 52 L72 48 Z" fill="#1C1917" stroke={glowColor} strokeWidth="0.5" opacity="0.6" />
      {/* 暗能量粒子 */}
...
const Zombie = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#zombie-glow)">
      {/* 头 */}
      <rect x="28" y="18" width="44" height="38" rx="2" fill="#4CAF50" stroke="#388E3C" strokeWidth="1.5" />
      {/* 眼睛 */}
      ...
      {/* 上衣 */}
      <rect x="28" y="56" width="44" height="32" rx="2" fill="#1976D2" stroke="#1565C0" strokeWidth="1" />
      {/* 裤子 */}
...
// 骷髅射手
const MCSkeleton = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#mcskel-glow)">
      {/* 头骨 */}
      <rect x="30" y="16" width="40" height="34" rx="2" fill="#E0E0E0" stroke="#9E9E9E" strokeWidth="1.5" />
      {/* 眼窝 */}
      ...
      {/* 弓 */}
      <path d="M16 45 C30 30 70 30 84 45" fill="none" stroke="#8D6E63" strokeWidth="3" strokeLinecap="round" />
...
// 苦力怕
const Creeper = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#creeper-glow)">
      {/* 头 */}
      <rect x="28" y="18" width="44" height="44" rx="1" fill="#4CAF50" stroke="#388E3C" strokeWidth="1.5" />
      {/* 经典苦力怕眼 */}
      <rect x="36" y="26" width="10" height="14" rx="0" fill="#1a1a2e" />
      <rect x="54" y="26" width="10" height="14" rx="0" fill="#1a1a2e" />
      {/* 嘴部（苦力怕标志性折线嘴） */}
      <path d="M34 48 L40 42 L46 48 L50 42 L54 48 L60 42 L66 48" fill="none" stroke="#1a1a2e" strokeWidth="3" strokeLinejoin="round" />
      {/* 身体 */}
      <rect x="32" y="62" width="36" height="26" rx="2" fill="#4CAF50" stroke="#388E3C" strokeWidth="1" />
      {/* 腿 */}
...
// 末影人
const Enderman = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#enderman-glow)">
      {/* 头 */}
      <rect x="32" y="12" width="36" height="34" rx="1" fill="#1a1a2e" stroke="#0d0d1a" strokeWidth="1.5" />
      {/* 紫色眼睛 */}
      ...
      {/* 身体（细长） */}
      <rect x="38" y="46" width="24" height="38" rx="0" fill="#1a1a2e" stroke="#0d0d1a" strokeWidth="1" />
      {/* 手臂 */}
...
const Blaze = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#blaze-glow)">
      {/* 头 */}
      <rect x="36" y="22" width="28" height="28" rx="2" fill="#F59E0B" stroke="#D97706" strokeWidth="1.5" />
      {/* 眼睛 */}
      ...
      {/* 身体 */}
      <rect x="40" y="50" width="20" height="20" rx="2" fill="#F59E0B" stroke="#D97706" strokeWidth="1" />
      {/* 烈焰棒 */}
      <rect x="24" y="42" width="4" height="26" rx="2" fill="#FBBF24" transform="rotate(-15 26 55)" />
      <rect x="72" y="42" width="4" height="26" rx="2" fill="#FBBF24" transform="rotate(15 74 55)" />
...
const Wither = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    <g filter="url(#wither-glow)">
      {/* 中间头 */}
      <rect x="38" y="8" width="24" height="22" rx="1" fill="#1C1917" stroke="#44403C" strokeWidth="1" />
      ...
      {/* 左头 */}
      <rect x="14" y="18" width="20" height="18" rx="1" fill="#1C1917" stroke="#44403C" strokeWidth="1" />
      ...
      {/* 右头 */}
      <rect x="66" y="18" width="20" height="18" rx="1" fill="#1C1917" stroke="#44403C" strokeWidth="1" />
...
// 末影龙
const EnderDragon = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
    ...
    <g filter="url(#edragon-glow)">
      {/* 龙头 */}
      <path d="M30 35 L22 28 L28 40 L22 50 L36 52 L44 38 Z" fill="#1C1917" stroke="#44403C" strokeWidth="1.5" />
      {/* 下颌 */}
      ...
      {/* 身体 */}
      <rect x="44" y="46" width="40" height="20" rx="2" fill="#1C1917" stroke="#44403C" strokeWidth="1" />
      {/* 翅膀 */}
      <path d="M48 46 L38 28 L56 28 L66 42 Z" fill="#2D2420" stroke="#44403C" strokeWidth="1" opacity="0.8" />
      <path d="M68 46 L78 28 L86 28 L66 42 Z" fill="#2D2420" stroke="#44403C" strokeWidth="1" opacity="0.8" />
      {/* 龙角 */}
      <path d="M26 30 L18 18 L30 28" fill="none" stroke="#44403C" strokeWidth="2.5" strokeLinecap="round" />
    </g>
  </svg>
);

// === PvZ 植物大战僵尸 Boss ===
const PvzBasic = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzb-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzb-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzb-bg)"/><g filter="url(#pvzb-g)"><rect x="30" y="22" width="40" height="34" rx="2" fill="#6B8E4E" stroke="#556B2F" strokeWidth="1.5"/><rect x="36" y="28" width="8" height="10" fill="#FFE4B5"/><rect x="56" y="28" width="8" height="10" fill="#FFE4B5"/><circle cx="40" cy="33" r="3" fill="#1a1a2e"/><circle cx="60" cy="33" r="3" fill="#1a1a2e"/><rect x="38" y="42" width="24" height="4" rx="1" fill="#4A3728"/><rect x="32" y="56" width="36" height="28" rx="2" fill="#8B7355"/><rect x="28" y="58" width="4" height="20" rx="1" fill="#6B8E4E"/><rect x="68" y="58" width="4" height="20" rx="1" fill="#6B8E4E"/></g></svg>
);
const PvzCone = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzc-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzc-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzc-bg)"/><g filter="url(#pvzc-g)"><polygon points="32,24 68,24 60,46 40,46" fill="#FF8C00" stroke="#E07000" strokeWidth="1.5"/><rect x="30" y="46" width="40" height="30" rx="2" fill="#6B8E4E" stroke="#556B2F" strokeWidth="1"/><rect x="36" y="50" width="8" height="8" fill="#FFE4B5"/><rect x="56" y="50" width="8" height="8" fill="#FFE4B5"/><circle cx="40" cy="54" r="2.5" fill="#1a1a2e"/><circle cx="60" cy="54" r="2.5" fill="#1a1a2e"/><rect x="40" y="62" width="20" height="4" rx="1" fill="#4A3728"/></g></svg>
);
const PvzBucket = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzbu-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzbu-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzbu-bg)"/><g filter="url(#pvzbu-g)"><rect x="32" y="14" width="36" height="20" rx="1" fill="#808080" stroke="#606060" strokeWidth="1.5"/><rect x="30" y="34" width="40" height="34" rx="2" fill="#6B8E4E" stroke="#556B2F" strokeWidth="1"/><rect x="36" y="40" width="8" height="8" fill="#FFE4B5"/><rect x="56" y="40" width="8" height="8" fill="#FFE4B5"/><circle cx="40" cy="44" r="2.5" fill="#1a1a2e"/><circle cx="60" cy="44" r="2.5" fill="#1a1a2e"/><rect x="38" y="52" width="24" height="4" rx="1" fill="#4A3728"/></g></svg>
);
const PvzDisco = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzd-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzd-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzd-bg)"/><g filter="url(#pvzd-g)"><rect x="30" y="18" width="40" height="20" rx="2" fill="#FF1493"/><rect x="24" y="14" width="10" height="10" rx="1" fill={glowColor} opacity="0.7"/><rect x="66" y="14" width="10" height="10" rx="1" fill={glowColor} opacity="0.7"/><rect x="30" y="38" width="40" height="34" rx="2" fill="#6B8E4E" stroke="#556B2F" strokeWidth="1"/><rect x="36" y="44" width="8" height="8" fill="#FFE4B5"/><rect x="56" y="44" width="8" height="8" fill="#FFE4B5"/><circle cx="40" cy="48" r="2.5" fill="#1a1a2e"/><circle cx="60" cy="48" r="2.5" fill="#1a1a2e"/></g></svg>
);
const PvzFootball = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzf-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzf-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzf-bg)"/><g filter="url(#pvzf-g)"><ellipse cx="50" cy="22" rx="16" ry="10" fill="#8B0000"/><rect x="46" y="28" width="8" height="4" fill="#4A3728"/><rect x="30" y="32" width="40" height="34" rx="2" fill="#6B8E4E" stroke="#556B2F" strokeWidth="1"/><rect x="36" y="38" width="8" height="8" fill="#FFE4B5"/><rect x="56" y="38" width="8" height="8" fill="#FFE4B5"/><circle cx="40" cy="42" r="2.5" fill="#ff0000"/><circle cx="60" cy="42" r="2.5" fill="#ff0000"/><rect x="34" y="50" width="32" height="16" rx="2" fill="#8B0000"/><ellipse cx="50" cy="58" rx="10" ry="6" fill="#FFF" stroke="#CCC" strokeWidth="1"/></g></svg>
);
const PvzGargantuar = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzg-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzg-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzg-bg)"/><g filter="url(#pvzg-g)"><rect x="34" y="8" width="32" height="26" rx="2" fill="#8B4513" stroke="#6B3410" strokeWidth="1.5"/><rect x="38" y="12" width="6" height="8" fill="#FFE4B5"/><rect x="56" y="12" width="6" height="8" fill="#FFE4B5"/><circle cx="41" cy="16" r="2" fill="#ff0000"/><circle cx="59" cy="16" r="2" fill="#ff0000"/><rect x="30" y="34" width="40" height="44" rx="2" fill="#6B8E4E" stroke="#556B2F" strokeWidth="1"/><rect x="20" y="36" width="10" height="30" rx="1.5" fill="#8B4513"/><rect x="70" y="36" width="10" height="30" rx="1.5" fill="#8B4513"/></g></svg>
);
const PvzZomboss = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none"><defs><radialGradient id="pvzz-bg" cx="50%" cy="45%" r="50%"><stop offset="0%" stopColor={glowColor} stopOpacity="0.3"/><stop offset="100%" stopColor={color} stopOpacity="0.1"/></radialGradient><filter id="pvzz-g"><feGaussianBlur stdDeviation="2" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><circle cx="50" cy="50" r="48" fill="url(#pvzz-bg)"/><g filter="url(#pvzz-g)"><rect x="34" y="18" width="32" height="22" rx="2" fill="#4B0082" stroke="#3A0068" strokeWidth="1.5"/><rect x="38" y="22" width="6" height="6" fill="#FFE4B5"/><rect x="56" y="22" width="6" height="6" fill="#FFE4B5"/><circle cx="41" cy="25" r="2" fill="#ff0000"/><circle cx="59" cy="25" r="2" fill="#ff0000"/><rect x="42" y="30" width="16" height="4" rx="1" fill="#2a1a3e"/><rect x="30" y="40" width="40" height="36" rx="3" fill="#4B0082" stroke="#3A0068" strokeWidth="1"/><circle cx="40" cy="52" r="6" fill={glowColor} opacity="0.5"/><circle cx="60" cy="52" r="6" fill={glowColor} opacity="0.5"/><rect x="24" y="44" width="8" height="20" rx="1.5" fill="#6B8E4E"/><rect x="68" y="44" width="8" height="20" rx="1.5" fill="#6B8E4E"/></g></svg>
);
// === 超能装甲兵团 Boss ===

// 黑熊坦克 — 艾布拉姆斯被生命珠复活，黑暗生物，周身布满武器，贪婪吞噬
const TankDarkbear = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="tdb-g"><feGaussianBlur stdDeviation="1.5" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#tdb-bg)" />
    <g filter="url(#tdb-g)">
      {/* 车体 */}
      <rect x="10" y="42" width="80" height="24" rx="3" fill="#1C1917" stroke="#44403C" strokeWidth="1.5" />
      {/* 履带 */}
      <rect x="8" y="60" width="84" height="10" rx="5" fill="#292524" stroke="#1C1917" strokeWidth="1" />
      <circle cx="20" cy="65" r="4" fill="#44403C" /><circle cx="35" cy="65" r="4" fill="#44403C" />
      <circle cx="50" cy="65" r="4" fill="#44403C" /><circle cx="65" cy="65" r="4" fill="#44403C" />
      <circle cx="80" cy="65" r="4" fill="#44403C" />
      {/* 炮塔 */}
      <rect x="30" y="26" width="30" height="18" rx="4" fill="#292524" stroke="#44403C" strokeWidth="1" />
      {/* 主炮 */}
      ...
      {/* 吞噬符号 */}
      <text x="44" y="56" fontSize="10" fill="#EF4444" fontWeight="bold">⚔</text>
    </g>
  </svg>
);

// 小渣 — 黑暗能量体，可脱离附身，紫色幽灵状+坦克轮廓
const TankXiaozha = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="txz-g"><feGaussianBlur stdDeviation="2" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    ...
    <g filter="url(#txz-g)">
      ...
      {/* 飘散的能量触手 */}
      <path d="M28 50 Q22 44 18 50 Q14 56 20 60" fill="none" stroke={glowColor} strokeWidth="2" opacity="0.5" />
      <path d="M72 50 Q78 44 82 50 Q86 56 80 60" fill="none" stroke={glowColor} strokeWidth="2" opacity="0.5" />
      {/* 粒子 */}
...
const TankSherman = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="tsh-g"><feGaussianBlur stdDeviation="1.5" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#tsh-bg)" />
    <g filter="url(#tsh-g)">
      {/* 车体 */}
      <rect x="12" y="46" width="76" height="20" rx="3" fill="#1E40AF" stroke="#1E3A8A" strokeWidth="1.5" />
      {/* 履带 */}
      <rect x="8" y="62" width="84" height="10" rx="5" fill="#172554" />
      <circle cx="20" cy="67" r="4" fill="#1E3A8A" /><circle cx="36" cy="67" r="4" fill="#1E3A8A" />
      <circle cx="52" cy="67" r="4" fill="#1E3A8A" /><circle cx="68" cy="67" r="4" fill="#1E3A8A" />
      <circle cx="80" cy="67" r="4" fill="#1E3A8A" />
      {/* 炮塔 */}
      <rect x="32" y="28" width="26" height="20" rx="4" fill="#2563EB" stroke="#1D4ED8" strokeWidth="1" />
      {/* 主炮 */}
      ...
      {/* 闪电符号（炫耀） */}
      <text x="42" y="56" fontSize="10" fill="#FBBF24" fontWeight="bold">★</text>
    </g>
  </svg>
);

// 小半 — 63A水陆两栖，冲动，操控水火电三元素
const TankXiaoban = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="txb-g"><feGaussianBlur stdDeviation="1.5" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#txb-bg)" />
    <g filter="url(#txb-g)">
      {/* 车体 — 水陆两栖外形更扁宽 */}
      <rect x="8" y="46" width="84" height="18" rx="5" fill="#0E7490" stroke="#155E75" strokeWidth="1.5" />
      {/* 履带+浮箱 */}
      <rect x="6" y="60" width="88" height="10" rx="5" fill="#164E63" />
      <circle cx="18" cy="65" r="4" fill="#155E75" /><circle cx="34" cy="65" r="4" fill="#155E75" />
      <circle cx="50" cy="65" r="4" fill="#155E75" /><circle cx="66" cy="65" r="4" fill="#155E75" />
      <circle cx="82" cy="65" r="4" fill="#155E75" />
      {/* 炮塔 */}
      <rect x="36" y="30" width="22" height="18" rx="4" fill="#0891B2" stroke="#0E7490" strokeWidth="1" />
      {/* 炮管 */}
      ...
      {/* 火 🔥 */}
      <path d="M76 28 Q78 20 74 24 Q72 18 76 22 Q80 16 78 24 Q82 20 80 28 Z" fill="#F97316" opacity="0.7" />
      <path d="M77 24 Q78 20 76 22 Q74 18 77 22 Q79 16 78 22 Z" fill="#FBBF24" opacity="0.6" />
      {/* 电 ⚡ */}
      <path d="M44 18 L48 26 L42 24 L46 32" fill="none" stroke="#FDE047" strokeWidth="2.5" strokeLinecap="round" opacity="0.8" />
    </g>
  </svg>
);

// 小绿 — T-34，温柔不自信，时钟/时间静止
const TankXiaolv = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="txl-g"><feGaussianBlur stdDeviation="1.5" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#txl-bg)" />
    <g filter="url(#txl-g)">
      {/* 车体 — T-34经典圆弧 */}
      <rect x="10" y="46" width="80" height="20" rx="3" fill="#166534" stroke="#14532D" strokeWidth="1.5" />
      {/* 履带 */}
      <rect x="8" y="62" width="84" height="10" rx="5" fill="#052E16" />
      <circle cx="20" cy="67" r="4" fill="#14532D" /><circle cx="36" cy="67" r="4" fill="#14532D" />
      <circle cx="52" cy="67" r="4" fill="#14532D" /><circle cx="68" cy="67" r="4" fill="#14532D" />
      ...
      <line x1="44" y1="38" x2="44" y2="33" stroke={glowColor} strokeWidth="1.5" strokeLinecap="round" />
      <line x1="44" y1="38" x2="48" y2="38" stroke={glowColor} strokeWidth="1" strokeLinecap="round" />
      {/* 时空涟漪 */}
      <circle cx="44" cy="38" r="11" fill="none" stroke={glowColor} strokeWidth="0.5" opacity="0.4" />
      <circle cx="44" cy="38" r="15" fill="none" stroke={glowColor} strokeWidth="0.3" opacity="0.25" />
      {/* 柔和光芒 */}
...
const TankZhuguli = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="tzg-g"><feGaussianBlur stdDeviation="1.5" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#tzg-bg)" />
    <g filter="url(#tzg-g)">
      {/* 底盘 — 巨大的铁路炮基座 */}
      <rect x="4" y="54" width="92" height="14" rx="2" fill="#78350F" stroke="#451A03" strokeWidth="1.5" />
      {/* 铁路轮子 */}
      ...
      <rect x="22" y="20" width="64" height="16" rx="4" fill="#92400E" stroke="#78350F" strokeWidth="1" />
      {/* 炮口 */}
      <rect x="84" y="22" width="8" height="12" rx="2" fill="#D97706" stroke="#B45309" strokeWidth="1" />
      {/* 虫洞 — 行星跳跃 */}
...
const TankDahu = ({ size, color, glowColor }: { size: number; color: string; glowColor: string }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <defs>
      ...
      <filter id="tdh-g"><feGaussianBlur stdDeviation="1.5" result="b" /><feMerge><feMergeNode in="b" /><feMergeNode in="SourceGraphic" /></feMerge></filter>
    </defs>
    <circle cx="50" cy="50" r="48" fill="url(#tdh-bg)" />
    <g filter="url(#tdh-g)">
      {/* 车体 — 虎式坦克方正厚重的轮廓 */}
      <rect x="8" y="44" width="84" height="22" rx="2" fill="#451A03" stroke="#291002" strokeWidth="2" />
      {/* 虎纹涂装 */}
      ...
      <circle cx="18" cy="67" r="4.5" fill="#451A03" /><circle cx="34" cy="67" r="4.5" fill="#451A03" />
      <circle cx="50" cy="67" r="4.5" fill="#451A03" /><circle cx="66" cy="67" r="4.5" fill="#451A03" />
      <circle cx="82" cy="67" r="4.5" fill="#451A03" />
      {/* 炮塔 — 虎式坦克棱角分明的炮塔 */}
      <rect x="28" y="24" width="28" height="22" rx="2" fill="#78350F" stroke="#451A03" strokeWidth="1" />
      {/* 长炮管 — 88mm炮 */}
      ...
      {/* 虎头标志 */}
      <text x="38" y="40" fontSize="8" fill={glowColor} opacity="0.9">🐯</text>
      {/* 生命能量射线 */}
...
export default function BossAvatar({ icon, color, glowColor, size = 56, className }: BossAvatarProps) {
